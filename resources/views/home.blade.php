  ...
  <div class="page-head-inner">
    <div class="page-head-caption container text-left">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-11">
            <p class="animate" data-animation="fadeInLeft" data-timeout="800">Tropical paradise island in the Indian
              Ocean</p>
            <h2 style="text-shadow: 2px 2px 5px  #363636;" class="big-title mb-10 animate" data-animation="fadeInRight"
              data-timeout="800">Avoga Holidays</h2>
            <p class="animate mb-20" data-animation="fadeInLeft" data-timeout="800">for travellers seeking true
              smiles... </p>
            <a href="#packages" class="btn btn-4 animate" data-animation="fadeInUp" data-timeout="900">Our Packages</a>
          </div>
        </div>
    ...
    <div class="page-head-inner">
      <div class="page-head-caption container text-left">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-11">
              <p class="animate clearfix" data-animation="fadeInUp" data-timeout="1000">Programs tailor-made just for
                you</p>
              <h2 style="text-shadow: 2px 2px 5px  #363636;" class="big-title mb-10 animate" data-animation="fadeInUp"
                data-timeout="800">Safari in National Parks</h2>
              <p class="animate mb-20" data-animation="fadeInLeft" data-timeout="800">Exclusively for animals and bird
                lovers.</p>
              <a href="#packages" class="btn btn-4 animate" data-animation="fadeInUp" data-timeout="1200">Our
                Packages</a>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-11">
              ...
              <h2 style="text-shadow: 2px 2px 5px  #363636;" class="big-title mb-10 animate" data-animation="fadeInUp"
                data-timeout="800">Bird Watching & Landscapes</h2>
              <p class="animate mb-20" data-animation="fadeInLeft" data-timeout="800">Exclusively for animals and bird
                lovers.</p>
              <a href="#packages" class="btn btn-4 animate" data-animation="fadeInUp" data-timeout="1200">Our
                Packages</a>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-11">
                ...
                <h2 style="text-shadow: 2px 2px 5px  #363636;" class="big-title mb-10 animate" data-animation="fadeInUp"
                  data-timeout="800">White Water Rafting & More</h2>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-11">
              ...
              <h2 style="text-shadow: 2px 2px 5px  #363636;" class="big-title mb-10 animate" data-animation="fadeInUp"
                data-timeout="800">Luck is Called Leopard</h2>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="tour-item">
          ...
          <div class="caption">
            <a href="{{ route('itinerary', $post->find(2)) }}">
              <p class="title">{{$post->find(2)->title}}</p>
            </a>
            <p class="date"><span class="ti-calendar"></span><?php echo date("Y/m/d") ?></p>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="tour-item">
          ...
          <div class="caption">
            <a href="{{ route('itinerary', $post->find(3)) }}">
              <p class="title">{{$post->find(3)->title}}</p>
            </a>
            <p class="date"><span class="ti-calendar"></span><?php echo date("Y/m/d") ?></p>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="tour-item">
          ...
          <div class="caption">
            <a href="{{ route('itinerary', $post->find(4)) }}">
              <p class="title">{{$post->find(4)->title}}</p>
            </a>
            <p class="date"><span class="ti-calendar"></span><?php echo date("Y/m/d") ?></p>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="tour-item">
          ...
          <div class="caption">
            <a href="{{ route('itinerary', $post->find(5)) }}">
              <p class="title">{{$post->find(5)->title}}</p>
            </a>
            <p class="date"><span class="ti-calendar"></span><?php echo date("Y/m/d") ?></p>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="tour-item">
          ...
          <div class="caption">
            <a href="{{ route('itinerary', $post->find(6)) }}">
              <p class="title">{{$post->find(6)->title}}</p>
            </a>
            <p class="date"><span class="ti-calendar"></span><?php echo date("Y/m/d") ?></p>
...
<div class="ctoa text-center parallax-container color-white" class="lazyload"
  style="background-image: url('{{ asset('img/ancient_roots_3.jpg')}}');">
  <div class="row justify-content-center">
    <div class="col-md-8">
