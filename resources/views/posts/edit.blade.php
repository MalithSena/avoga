                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                       ...
                       <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            @for($i=1; $i < 4; $i++)
                                <select name="similar[]" id="similar" class="form-control">  
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="tagline" id="tagline" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        @if(empty($post->tips))
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                <input type="text" name="tips[]" id="tips" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                    value="{{ "Tip " . $i }}" />
                                @endfor 
                            </div>
                        @else                  
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="introduction" id="introduction" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        @if(empty($post->from_to) && empty($post->tour_itinerary))
                            <div class="px-4 py-5 bg-white sm:p-6">                            
                                ...
                                <input type="text" name="from_to[]" id="from_to" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                    value=""/>
                                <label for="tour_itinerary" class="block font-medium text-sm text-gray-700">Tour Itinerary</label>
                                <input type="text" name="tour_itinerary[]" id="tour_itinerary" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                    value="" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="map_url" id="map_url" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="gallery_image_1" class="block font-medium text-sm text-gray-700">Gallery Image 1</label>
                            <input type="file" name="gallery_image_1" id="gallery_image_1" type="file" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="gallery_image_2" class="block font-medium text-sm text-gray-700">Gallery Image 2</label>
                            <input type="file" name="gallery_image_2" id="gallery_image_2" type="file" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="gallery_image_3" class="block font-medium text-sm text-gray-700">Gallery Image 3</label>
                            <input type="file" name="gallery_image_3" id="gallery_image_3" type="file" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="gallery_image_4" class="block font-medium text-sm text-gray-700">Gallery Image 4</label>
                            <input type="file" name="gallery_image_4" id="gallery_image_4" type="file" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="gallery_image_5" class="block font-medium text-sm text-gray-700">Gallery Image 5</label>
                            <input type="file" name="gallery_image_5" id="gallery_image_5" type="file" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="gallery_image_6" class="block font-medium text-sm text-gray-700">Gallery Image 6</label>
                            <input type="file" name="gallery_image_6" id="gallery_image_6" type="file" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="file" name="extra_image_1" id="extra_image_1" type="file" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="file" name="extra_image_2" id="extra_image_2" type="file" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="file" name="extra_image_3" id="extra_image_3" type="file" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="file" name="extra_image_4" id="extra_image_4" type="file" class="form-input rounded-md shadow-sm mt-1 block w-full"
