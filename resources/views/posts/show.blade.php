              ...
              <div class="col-md-12">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('posts.index') }}">Tours</a></li>
        ...
        <div class="tab-1">
          ...
          <div class="tab-content" id="myTabContent">
                ...
                <div class="col-md-6">
                  ...
                  <ul class="accordion-element accordion-2">
                    ...
                    @for($i = 0; $i < $post->days ; $i++)
                      <li>
                        {{-- <a class="toggle" href="javascript:void(0);" data-item="item-2">Day {{$i + 1 }}:
                        {{$from[($i)]}}</a> --}}
                        <a class="toggle" href="javascript:void(0);" data-item="item-2">Day {{$i + 1 }}:
                          {{$from[$i]}}</a>
                        <p class="inner">
            ...
            <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="map-tab">
              {{-- <iframe src="{{$post->map_url}}" width="600" height="450" frameborder="0" style="border:0;"
          ...
          <a href="{{$tour}}">
            ...
            <div class="caption">
              ...
              <a href="{{$post->findOrFail($tour)->id }}">
                <p class="title">{{$post->findOrFail($tour)->title}}</p>
              </a>
