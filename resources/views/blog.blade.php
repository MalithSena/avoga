@extends('layouts.site')
 ...
 @section('content')
    ...
    <div class="page-head white-content">
      <div class="height50vh parallax-container" style="background-image: url('{{ asset('img/cat_main_imgs/cat_main_blog.jpg') }}">
    ...
    <div class="content mt-60 mb-40 container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="blog-item effect-1">
            <a class="block" href="{{asset('destinations/kandy')}}">
              <img src="{{asset('img/destinations/kandy_main.jpg')}}" alt="img12">
            </a>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="blog-item effect-1">
            <a class="block" href="{{asset('destinations/galle')}}">
              <img src="{{asset('img/destinations/galle_main.jpg')}}" alt="Galle">
            </a>
            <div class="caption clearfix">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="blog-item effect-1">
            <a class="block" href="{{asset('destinations/jaffna')}}">
              <img src="{{asset('img/destinations/jaffna_main.jpg')}}" alt="Jaffna">
            </a>
            <div class="caption clearfix">
              <a href="{{asset('destinations/jaffna')}}">
                <p class="title">Jaffna</p>
              </a>
              <p class="date"><span class="ti-calendar"></span>August 20, 2018</p>
              <p class="author"><span class="ti-user"></span>By AvogaHolidays</p>
              <ul class="tags">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="blog-item effect-1">
            <a class="block" href="{{asset('destinations/yala')}}">
              <img src="{{asset('img/destinations/yala_main.jpg')}}" alt="Yala">
            </a>
            <div class="caption clearfix">
              <a href="{{asset('destinations/yala')}}">
                <p class="title">Yala</p>
              </a>
              <p class="date"><span class="ti-calendar"></span>August 20, 2018</p>
              <p class="author"><span class="ti-user"></span>By AvogaHolidays</p>
              <ul class="tags">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="blog-item effect-1">
            <a class="block" href="{{asset('destinations/minneriya')}}">
              <img src="{{asset('img/destinations/minneriya_main.jpg')}}" alt="Minneriya">
            </a>
            <div class="caption clearfix">
              <a href="{{asset('destinations/minneriya')}}">
                <p class="title">Minneriya National Park</p>
              </a>
              <p class="date"><span class="ti-calendar"></span>August 20, 2018</p>
              <p class="author"><span class="ti-user"></span>By AvogaHolidays</p>
              <ul class="tags">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="blog-item effect-1">
            <a class="block" href="{{asset('destinations/sigiriya')}}">
              <img src="{{asset('img/destinations/sigiriya_main.jpg')}}" alt="img12">
            </a>
            <div class="caption clearfix">
              <a href="{{asset('destinations/sigiriya')}}">
                <p class="title">Sigiriya</p>
              </a>
              <p class="date"><span class="ti-calendar"></span>August 20, 2018</p>
              <p class="author"><span class="ti-user"></span>By AvogaHolidays</p>
              <ul class="tags">
