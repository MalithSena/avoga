    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="tour-item">
          ...
          <a href="<?php echo e($post->findOrFail($tour)->slug); ?>">
            <?php else: ?>
            <a href="<?php echo e($post->findOrFail($tour)->slug); ?>">
              <?php endif; ?>
              <div class="img-wrap">
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Google Drive\Avoga Version control\avoga\resources\views/itinerary.blade.php ENDPATH**/ ?>